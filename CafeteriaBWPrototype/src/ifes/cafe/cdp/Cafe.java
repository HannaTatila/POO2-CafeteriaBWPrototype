...
public class Cafe {
    ...
    private ArrayList<IngredientePrototype> ingredientes;
    ...
    public ArrayList<IngredientePrototype> getIngredientes() {
        return ingredientes;
    }

    public void setIngredientes(ArrayList<IngredientePrototype> ingredientes) {
    ...
    public String toString() {
        ...
        int cont = 0;
        for (IngredientePrototype ing : ingredientes) {
